Webruntime.define('lwc/modalItem', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$4($api, $cmp, $slotset, $ctx) {
      ...
      return [$cmp.showModal ? api_element("section", {
        ...
        key: 6,
        on: {
          "slotchange": _m1 || ($ctx._m1 = api_bind($cmp.handleSlotFooterChange))
        }
        ...
        key: 8,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.handleCancel))
        }
      ...
      }, [api_text("Save")])]) : null])]) : null, $cmp.showModal ? api_element("div", {
        classMap: {
          "slds-backdrop": true,
    ...
    tmpl$4.slots = ["modalName", "modalContent", "footer"];
    tmpl$4.stylesheets = [];
    tmpl$4.stylesheetTokens = {
      hostAttribute: "lwc-modalItem_modalItem-host",
      shadowAttribute: "lwc-modalItem_modalItem"
    };

    const CSS_CLASS = 'modal-hidden';

    class ModalItem extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
      ...
      //     console.log('modalItem event: ', JSON.stringify(event));
      ...
      handleClick(event) {
        const createdEvent = new CustomEvent('createdtodo', {
          detail: 'event modalItem!!!'
        });
      ...
      handleCancelClickP(event) {
        console.log('modalItem handleCancelClickP'); // this.dispatchEvent(
        //     new CustomEvent(
        //         'cancelclick',
      ...
      handleDialogClose() {
        ...
        // const closedialog = new CustomEvent('closedialog', { detail: 'closedialog!!!' });
    ...
    lwc.registerDecorators(ModalItem, {
      publicMethods: ["show", "hide"],
      fields: ["showModal", "showFooter"]
    });

    var modalItem = lwc.registerComponent(ModalItem, {
      tmpl: _tmpl$5
    });
