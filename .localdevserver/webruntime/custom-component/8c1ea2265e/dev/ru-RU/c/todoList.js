Webruntime.define('lwc/todoList', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "li:not(:first-child)" + shadowSelector + " {border-top: solid 1px #ecebea;}\n";
    }
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 5
      }, api_iterator($cmp.filteredTodos, function (todo) {
        return api_element("li", {
          key: api_key(4, todo.id)
        }, [api_element("div", {
          classMap: {
          ...
          key: 1
        }, [api_dynamic(todo.description)]), api_element("p", {
          key: 2
        }, [api_text("Priority: "), api_dynamic(todo.priority)])])]);
      }))])];
    }
